...
class XapianQuery {
    ...
    function __construct($tname_or_op__or_copyme_or_op=null,$wqf_or_left_or_valno_or_subqs_or_q=null,$term_pos_or_right_or_begin_or_param=null,$end=null) {
        switch (func_num_args()) {
        ...
        case 3: $r=new_Query($tname_or_op__or_copyme_or_op,$wqf_or_left_or_valno_or_subqs_or_q,$term_pos_or_right_or_begin_or_param); break;
        default: $r=new_Query($tname_or_op__or_copyme_or_op,$wqf_or_left_or_valno_or_subqs_or_q,$term_pos_or_right_or_begin_or_param,$end);
        }
        $this->_cPtr=$r;
    }
