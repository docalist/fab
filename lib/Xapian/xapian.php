...
class XapianValueMapPostingSource extends XapianValuePostingSource {
    ...
    function add_mapping($key,$weight) {
        ValueMapPostingSource_add_mapping($this->_cPtr,$key,$weight);
    }
...
class XapianRegistry {
    ...
    function __construct($other=null) {
        switch (func_num_args()) {
        case 0: $r=new_Registry(); break;
        default: $r=new_Registry($other);
        }
        $this->_cPtr=$r;
    }
    ...
    function get_posting_source($name) {
        ...
        return is_resource($r) ? new XapianPostingSource($r) : $r;
    }
    ...
    function get_match_spy($name) {
        ...
        return is_resource($r) ? new XapianMatchSpy($r) : $r;
    }
}
...
class XapianBM25Weight extends XapianWeight {
    ...
    function __construct($k1=null,$k2=null,$k3=null,$b=null,$min_normlen=null) {
        ...
        case 1: $r=new_BM25Weight($k1); break;
        case 2: $r=new_BM25Weight($k1,$k2); break;
        case 3: $r=new_BM25Weight($k1,$k2,$k3); break;
        case 4: $r=new_BM25Weight($k1,$k2,$k3,$b); break;
        default: $r=new_BM25Weight($k1,$k2,$k3,$b,$min_normlen);
        }
        $this->_cPtr=$r;
    }
...
abstract class XapianMatchSpy {
    ...
    function clone_object() {
        $r=MatchSpy_clone_object($this->_cPtr);
        return is_resource($r) ? new XapianMatchSpy($r) : $r;
    }
    ...
    function serialise() {
        return MatchSpy_serialise($this->_cPtr);
    }

    function unserialise($s,$context) {
        $r=MatchSpy_unserialise($this->_cPtr,$s,$context);
        return is_resource($r) ? new XapianMatchSpy($r) : $r;
    }

    function serialise_results() {
        return MatchSpy_serialise_results($this->_cPtr);
    }
...
class XapianValueCountMatchSpy extends XapianMatchSpy {
    ...
    function __construct($slot_=null) {
        ...
        switch (func_num_args()) {
        case 0: $r=new_ValueCountMatchSpy(); break;
        default: $r=new_ValueCountMatchSpy($slot_);
        }
        $this->_cPtr=$r;
    }
    ...
    function clone_object() {
        $r=ValueCountMatchSpy_clone_object($this->_cPtr);
        return is_resource($r) ? new XapianMatchSpy($r) : $r;
    }
    ...
    function serialise() {
        return ValueCountMatchSpy_serialise($this->_cPtr);
    }

    function unserialise($s,$context) {
        $r=ValueCountMatchSpy_unserialise($this->_cPtr,$s,$context);
        return is_resource($r) ? new XapianMatchSpy($r) : $r;
    }

    function serialise_results() {
        return ValueCountMatchSpy_serialise_results($this->_cPtr);
    }
...
class XapianQuery {
    ...
    function __construct($copyme_or_tname__or_op__or_external_source_or_op=null,$wqf__or_left_or_q_or_valno_or_subqs=null,$pos__or_right_or_parameter_or_begin_or_value_or_param=null,$end=null) {
        switch (func_num_args()) {
        case 0: $r=new_Query(); break;
        case 1: $r=new_Query($copyme_or_tname__or_op__or_external_source_or_op); break;
        case 2: $r=new_Query($copyme_or_tname__or_op__or_external_source_or_op,$wqf__or_left_or_q_or_valno_or_subqs); break;
        case 3: $r=new_Query($copyme_or_tname__or_op__or_external_source_or_op,$wqf__or_left_or_q_or_valno_or_subqs,$pos__or_right_or_parameter_or_begin_or_value_or_param); break;
        default: $r=new_Query($copyme_or_tname__or_op__or_external_source_or_op,$wqf__or_left_or_q_or_valno_or_subqs,$pos__or_right_or_parameter_or_begin_or_value_or_param,$end);
        }
        $this->_cPtr=$r;
    }
}
...
class XapianStringValueRangeProcessor extends XapianValueRangeProcessor {
    ...
    function __construct($valno_,$str_=null,$prefix_=true) {
        switch (func_num_args()) {
        case 1: $r=new_StringValueRangeProcessor($valno_); break;
        default: $r=new_StringValueRangeProcessor($valno_,$str_,$prefix_);
        }
        $this->_cPtr=$r;
    }
...
class XapianDateValueRangeProcessor extends XapianStringValueRangeProcessor {
    ...
    function __construct($valno_,$prefer_mdy__or_str_=null,$epoch_year__or_prefix_=null,$prefer_mdy_=null,$epoch_year_=null) {
        switch (func_num_args()) {
        case 1: $r=new_DateValueRangeProcessor($valno_); break;
        case 2: $r=new_DateValueRangeProcessor($valno_,$prefer_mdy__or_str_); break;
        case 3: $r=new_DateValueRangeProcessor($valno_,$prefer_mdy__or_str_,$epoch_year__or_prefix_); break;
        case 4: $r=new_DateValueRangeProcessor($valno_,$prefer_mdy__or_str_,$epoch_year__or_prefix_,$prefer_mdy_); break;
        default: $r=new_DateValueRangeProcessor($valno_,$prefer_mdy__or_str_,$epoch_year__or_prefix_,$prefer_mdy_,$epoch_year_);
        }
        $this->_cPtr=$r;
    }
...
class XapianMultiValueKeyMaker extends XapianKeyMaker {
    ...
    function add_value($valno,$reverse=false) {
        MultiValueKeyMaker_add_value($this->_cPtr,$valno,$reverse);
    }
}
